...
> > 2. **Perangkat lunak bekerja** lebih berharga daripada dokumentasi lengkap
> > 3. **Kolaborasi pelanggan** lebih utama daripada negosiasi kontrak
...
> >
> > 1. **Pengiriman berkala**: Produk fungsional diserahkan setiap 2-4 minggu
> > 2. **Umpan balik kontinu**: Uji coba dan validasi dilakukan setiap iterasi
> > 3. **Kolaborasi tim**: Developer, manajer, dan pelanggan bekerja intensif
> > 4. **Adaptasi perubahan**: Persyaratan bisa berkembang selama proyek
> > 5. **Keterlibatan aktif pelanggan**: Pelanggan menjadi bagian tim pengembang
> > 6. **Proses "pas"**: Kerangka kerja disesuaikan dengan kompleksitas proyek
> >
...
>
> 1. **Simulasi permainan Lego Agile**: Bentuk tim 5 orang untuk membangun struktur Lego dengan iterasi 10 menit. Catat bagaimana perubahan kebutuhan memengaruhi strategi dan komunikasi tim.
> 2. **Analisis studi kasus Spotify Squad Model**: Telusuri bagaimana Spotify menerapkan prinsip Agile pada 120+ tim pengembang. Identifikasi mekanisme koordinasi antar-squad tanpa hierarki formal.
>
> #### Further Reading
>
