...
Baca cepat 1 jam sebelum ujian.

Fokus: konsep yang **berulang tiap tahun** + jebakan **KECUALI**. 🧵👇

Strategi menang: kuasai tabel KECUALI dulu, lalu Scrum + UML + SPLE.

Itu ~70% soal pilihan ganda. 💪

## 🪤 Jebakan "KECUALI"

Hafalkan jawaban yang SALAH / bukan. Ini paling sering keluar.

Peran arsitektur, KECUALI → **Prototipe dari sistem**.

Komponen DSSA, KECUALI → **Reference model**.

Kelebihan **GPL**, KECUALI → **Mudah digunakan domain expert** (itu DSL).

Kelebihan **DSL**, KECUALI → **Banyak dukungan IDE yang baik** (itu GPL).
...
**Burndown naik di Day X:** ada bug pada task yang sudah closed / salah estimasi beban.

**Metodologi agile:** Scrum, Extreme Programming (XP).

## 📐 UML (klasifikasi diagram)
...
**ULS System:** decentralization · conflicting/unknowable requirements · continuous evolution · normal failures · erosi batas manusia/sistem.

ULS Challenge: Design & Evolution, Orchestration & Control, Monitoring & Assessment.

**Scaling Agile — LeSS:** minimalism, 1 PO, shared backlog, sprint sinkron.

**Scaling Agile — SAFe:** value stream, Agile Release Train 5–15 tim/≤150 org, Program Increment.
...
**Cocok:** domain matang/stabil, banyak produk terkait (product line).

**Kurang tepat:** domain baru/berubah, proyek one-off (reference arch *not too-early, not too-late*).
