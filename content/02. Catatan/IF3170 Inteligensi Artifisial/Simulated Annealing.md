...
> >     
>>
> > 1. **Jika** _**neighbor**_ **lebih baik (**DeltaE0**)**: Algoritma **selalu** menerima langkah tersebut dan pindah ke _neighbor_. (Sama seperti Hill Climbing).
> >     
> > 2. **Jika** _**neighbor**_ **lebih buruk (**DeltaE\<0**)**: Algoritma mungkin masih menerima langkah tersebut, tetapi berdasarkan sebuah probabilitas yang dihitung dengan rumus:
> >     
> >     - P(textpindah)=eDeltaE/T  
> >         
> >
> > ### Peran Temperatur (T)
> >
...
>     
> 
> Jadwal yang umum digunakan adalah pendinginan geometris: T_new=alphatimesT_old (di mana alpha adalah konstanta pendinginan, misal 0.99).
> 
...
>     
> - **Value (**DeltaE**)**: Perubahan skor "kualitas" parafrase.
>     
...
>     
> - Coba hitung probabilitas kepindahan (eDeltaE/T) dengan dua nilai T yang berbeda: T=10 (tinggi) dan T=0.5 (rendah).
>     
